...
function ArticleCard({ article, onClick, onEntityClick = () => { } }) {
  ...
  const placeholderImage = 'https://cdn.pixabay.com/photo/2014/08/07/21/13/newspaper-412809_1280.jpg'; // Add this image to your public folder
  ...
  return (
    ...
    >
      {/* Always render image container with fallback */}
