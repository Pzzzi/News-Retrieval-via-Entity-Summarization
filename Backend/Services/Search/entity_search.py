...
def get_related_entities(entity_name: str):
...
def search_articles_by_entity(entity_name: str, related_entities: List[str]):
...
@app.get("/search")
async def search(entity: str = Query(..., description="Entity to search for")):
